option(gVirtualXRay_USE_KWSTYLE "Enable the use of KWStyle for checking coding style." OFF)
mark_as_advanced(gVirtualXRay_USE_KWSTYLE)
if(gVirtualXRay_USE_KWSTYLE)
...
set(KWSTYLE_CONFIGURATION_FILE
  ${PROJECT_BINARY_DIR}/cmake/KWStyle/gVirtualXRay.kws.xml)

set(KWSTYLE_gVirtualXRay_FILES_LIST
  ${PROJECT_BINARY_DIR}/cmake/KWStyle/gVirtualXRayFiles.txt)

set(KWSTYLE_gVirtualXRay_OVERWRITE_FILE
  ${PROJECT_SOURCE_DIR}/cmake/KWStyle/gVirtualXRayOverwrite.txt )

#
# Configure the files
#
configure_file(
  ${PROJECT_SOURCE_DIR}/cmake/KWStyle/gVirtualXRayFiles.txt.in
  ${KWSTYLE_gVirtualXRay_FILES_LIST})

configure_file(
  ${PROJECT_SOURCE_DIR}/cmake/KWStyle/gVirtualXRay.kws.xml.in
...
set(KWSTYLE_ARGUMENTS_CODE
  -xml ${KWSTYLE_CONFIGURATION_FILE} -v -D ${KWSTYLE_gVirtualXRay_FILES_LIST}
  -o ${KWSTYLE_gVirtualXRay_OVERWRITE_FILE} ${KWSTYLE_EDITOR_FORMAT}
  )

add_custom_command(
  OUTPUT  ${gVirtualXRay_BINARY_DIR}/KWStyleCodeReport.txt
  COMMAND ${KWSTYLE_EXECUTABLE}
  ARGS    ${KWSTYLE_ARGUMENTS_CODE}
  COMMENT "Coding Style Checker"
  )

add_custom_target(StyleCheckCode DEPENDS ${gVirtualXRay_BINARY_DIR}/KWStyleCodeReport.txt)

add_test(NAME KWStyleCodeTest
  COMMAND ${KWSTYLE_EXECUTABLE}
  ${KWSTYLE_ARGUMENTS_CODE}
  WORKING_DIRECTORY ${gVirtualXRay_SOURCE_DIR})
