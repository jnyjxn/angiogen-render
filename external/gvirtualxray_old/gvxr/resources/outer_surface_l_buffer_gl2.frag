...
********************************************************************************
*
*	@file		outer_surface_l_buffer_gl2.frag
*
...
//   Uniform variables
//******************************************************************************
uniform sampler2D g_cumulated_l_buffer_texture;
...
//-------------
{
	...
	gl_FragColor = vec4(-texture2D(g_cumulated_l_buffer_texture, g_texture_coordinates.st).r, 0.0, 0.0, 1.0);
}
