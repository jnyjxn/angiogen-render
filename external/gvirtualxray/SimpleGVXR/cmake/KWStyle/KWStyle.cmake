option(SimpleGVXR_USE_KWSTYLE "Enable the use of KWStyle for checking coding style." OFF)
mark_as_advanced(SimpleGVXR_USE_KWSTYLE)
if(SimpleGVXR_USE_KWSTYLE)
...
set(KWSTYLE_CONFIGURATION_FILE
  ${PROJECT_BINARY_DIR}/cmake/KWStyle/SimpleGVXR.kws.xml)

set(KWSTYLE_SimpleGVXR_FILES_LIST
  ${PROJECT_BINARY_DIR}/cmake/KWStyle/SimpleGVXRFiles.txt)

set(KWSTYLE_SimpleGVXR_OVERWRITE_FILE
  ${PROJECT_SOURCE_DIR}/cmake/KWStyle/SimpleGVXROverwrite.txt )

#
# Configure the files
#
configure_file(
  ${PROJECT_SOURCE_DIR}/cmake/KWStyle/SimpleGVXRFiles.txt.in
  ${KWSTYLE_SimpleGVXR_FILES_LIST})

configure_file(
  ${PROJECT_SOURCE_DIR}/cmake/KWStyle/SimpleGVXR.kws.xml.in
...
set(KWSTYLE_ARGUMENTS_CODE
  -xml ${KWSTYLE_CONFIGURATION_FILE} -v -D ${KWSTYLE_SimpleGVXR_FILES_LIST}
  -o ${KWSTYLE_SimpleGVXR_OVERWRITE_FILE} ${KWSTYLE_EDITOR_FORMAT}
  )

add_custom_command(
  OUTPUT  ${SimpleGVXR_BINARY_DIR}/KWStyleCodeReport.txt
  COMMAND ${KWSTYLE_EXECUTABLE}
  ARGS    ${KWSTYLE_ARGUMENTS_CODE}
  COMMENT "Coding Style Checker"
  )

add_custom_target(StyleCheckCode DEPENDS ${SimpleGVXR_BINARY_DIR}/KWStyleCodeReport.txt)

add_test(NAME KWStyleCodeTest
  COMMAND ${KWSTYLE_EXECUTABLE}
  ${KWSTYLE_ARGUMENTS_CODE}
  WORKING_DIRECTORY ${SimpleGVXR_SOURCE_DIR})
