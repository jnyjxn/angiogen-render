...
********************************************************************************
*
*   @file       outer_surface_l_buffer_gl4.frag
*
*   @brief      Fragment shader that computes the L-buffer. of the external surface.
*               see:
...
//   Uniform variables
//******************************************************************************
layout(location=2) uniform sampler2D g_cumulated_l_buffer_texture;
...
//-------------
{
    ...
    fragColor = vec3(-texture(g_cumulated_l_buffer_texture, g_texture_coordinates.st).r, 0.0, 0.0);
}
