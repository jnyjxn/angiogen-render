...
//	Input
//******************************************************************************
layout(location=0) smooth in vec3 g_normal;
layout(location=1) smooth in vec3 g_object_position;
layout(location=2) smooth in vec2 g_texture_coordinates;
...
//	Uniform variables
//******************************************************************************
layout(location=1) uniform vec4 g_base_colour;
layout(location=2) uniform vec4 g_second_colour;
layout(location=3) uniform int g_has_tendon;
layout(location=4) uniform int g_is_lung;
layout(location=5) uniform float g_texture_frequency;
layout(location=6) uniform sampler2D g_bump_map;
layout(location=7) uniform int g_perm[TAB_SIZE];
layout(location=7+TAB_SIZE) uniform vec3 g_gradient_tab[TAB_SIZE];
