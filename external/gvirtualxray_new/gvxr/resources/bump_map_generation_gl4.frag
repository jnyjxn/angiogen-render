...
layout(location=2) uniform int g_is_lung;
layout(location=3) uniform int g_has_thin_bumps;
layout(location=4) uniform mat4 g_right_line_matrix;
layout(location=5) uniform mat4 g_side_lines_matrix;
layout(location=6) uniform vec3 g_max_corner;
layout(location=7) uniform vec3 g_min_corner;
layout(location=8+64) uniform int g_perm[TAB_SIZE];
layout(location=8+64+64) uniform vec3 g_gradient_tab[TAB_SIZE];
